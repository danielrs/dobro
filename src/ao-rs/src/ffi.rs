...
extern {
    ...
    pub fn ao_open_live(driver_id: c_int, format: *mut AoSampleFormat, options: *mut AoOption) -> *mut AoDevice;
    pub fn ao_play(ao_device: *mut AoDevice, output_samples: *mut c_char, num_bytes: u32) -> c_int;
